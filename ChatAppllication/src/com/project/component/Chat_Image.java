...
import com.project.swing.PictureBox;
...
public class Chat_Image extends javax.swing.JLayeredPane {
    ...
    private void addEvent(Component com, Icon image) {
        ...
        // click chuột để xem hình ảnh
        com.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent me) {
                if (SwingUtilities.isLeftMouseButton(me)) {
                    PublicEvent.getInstance().getEventImageView().viewImage(image); //gọi đến hàm hiển thị hình ảnh trong Main
                }
            }
