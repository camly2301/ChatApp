...
public class ServiceFile {
    ...
    private final String INSERT = "INSERT INTO chat_application.files (FileExtension) VALUES (?)";
    ...
    private final String GET_FILE_EXTENSION = "SELECT FileExtension FROM chat_application.files WHERE FileID=? LIMIT 1";
    //instance
